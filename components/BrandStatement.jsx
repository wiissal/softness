...
const frameHeight =
  "h-[20rem] sm:h-[26rem] lg:h-[calc(100svh-14rem)] lg:max-h-[34rem]";
    ...
    >
      <div className="mx-auto grid w-full max-w-[1440px] items-center gap-12 lg:grid-cols-12 lg:gap-8">
        ...
        >
          ...
          >
            At Softness, we believe beautiful food starts with simple
            ingredients, thoughtful preparation and a little care.
          </motion.p>
        </motion.div>
        ...
        <div className="lg:col-span-4">
          <ImageReveal
            curtain="bg-ivory"
            className={[
              "w-full rounded-[2rem] lg:rounded-[2.5rem]",
              frameHeight,
            ].join(" ")}
          >
            <SoftImage
